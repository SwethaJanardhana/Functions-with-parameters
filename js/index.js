...
function logText() {
  console.log(
    "This text does not appear. Why?---> Because 'Parenthesis' where missing on the function call"
  );
}
...
console.log("Output with Generalized function and an input parameter...");
console.log("*********************************");
